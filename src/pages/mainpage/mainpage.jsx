        ...
        <div>
            ...
            <div className="space-y-80 font-['NanumSquareNeo-Variable']">
                ...
                <div className='flex justify-start items-center space-x-10 '>
                    ...
                    <img style={{width: '30.075rem', height: '20.075rem'}} data-aos = "fade-left" src={"https://images.unsplash.com/photo-1569163139500-66446e2926ca?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80"} alt={2} />
                </div>
                ...
                <div className='flex justify-center items-center space-x-40 space-y-24'>
                    <div className='space-y-80' >
                        ...
                        <div className="flex justify-center mt-4" data-aos="flip-right">
                            <a href="/login" className="bg-green-500 hover:bg-green-700 text-4xl text-white py-12 px-24 rounded-3xl inline-flex items-center">
                                <span>지금 시작하기</span>
